...
| Method | Endpoint | File | Description | JWT Required | Status |
| --- | --- | --- | --- | --- | --- |
| GET | `/recommendations/combo` | [get-combos.md](get-combos.md) | Get personalized meal combo recommendations | Yes | ✅ Built |
| GET | `/goals/daily` | [get-daily-goals.md](get-daily-goals.md) | Get today's nutrition goal progress | Yes | ✅ Built |
| GET | `/menus/summary` | [get-menu-summary.md](get-menu-summary.md) | Get today's highlighted menus per dining hall | Yes | ✅ Built |
| POST | `/meals/log` | [log-meal.md](log-meal.md) | Log a meal with food items | Yes | ✅ Built |
| POST | `/favorites` | [save-favorite.md](save-favorite.md) | Save a combo to favorites | Yes | Not built |
| DELETE | `/favorites/:favoriteId` | [delete-favorite.md](delete-favorite.md) | Remove a combo from favorites | Yes | Not built |
